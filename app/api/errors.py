"""Port of Oriexa/src/lib/api/errors.ts — every error code, message, and suggestion is identical."""
...
def invalid_api_key_error() -> JSONResponse:
    return error_response(
        ...
        "UNAUTHORIZED",
        "Invalid API key",
        "Use a pre-provisioned API key from your Oriexa administrator.",
    )
...
def agent_paused_error() -> JSONResponse:
    return error_response(
        ...
        "FORBIDDEN",
        "Agent is paused",
        "Contact your Oriexa administrator to reactivate this agent key.",
    )
